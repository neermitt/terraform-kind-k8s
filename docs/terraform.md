...
| Name | Version |
|------|---------|
| <a name="provider_docker-utils"></a> [docker-utils](#provider\_docker-utils) | >= 0.0.5 |
| <a name="provider_kind"></a> [kind](#provider\_kind) | >= 0.0.14 |
...
| <a name="input_kubeconfig_base_path"></a> [kubeconfig\_base\_path](#input\_kubeconfig\_base\_path) | directory, where kubeconfig should be generated, kubeconfig will have <cluster-name>.config pattern | `string` | `null` | no |
| <a name="input_kubeconfig_path"></a> [kubeconfig\_path](#input\_kubeconfig\_path) | file path, where kubeconfig should be stored, directory path should be provided as alternative | `string` | `null` | no |
...
| <a name="input_networking"></a> [networking](#input\_networking) | Multiple details of the cluster's networking can be customized under the networking field. See https://kind.sigs.k8s.io/docs/user/configuration/#networking | <pre>object({<br>    ip_family           = optional(string)<br>    api_server_address  = optional(string)<br>    api_server_port     = optional(number)<br>    pod_subnet          = optional(string)<br>    service_subnet      = optional(string)<br>    disable_default_cni = optional(bool)<br>    kube_proxy_mode     = optional(string)<br>  })</pre> | `null` | no |
| <a name="input_nodes"></a> [nodes](#input\_nodes) | values for the kind\_config node block | <pre>list(<br>    object({<br>      role  = string<br>      image = optional(string)<br>    })<br>  )</pre> | `[]` | no |
